...
--
-- Host: localhost
-- Generation Time: March 14, 2014 at 09:12 PM
...
INSERT INTO `categories` VALUES(1, 'Bakers');
INSERT INTO `categories` VALUES(2, 'Butchers');
INSERT INTO `categories` VALUES(3, 'Fruit & Veg');
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`customer`) REFERENCES `customers` (`id`) ON UPDATE CASCADE,
